...
Historical records should not be silently rewritten to match later behavior. If a historical statement is obsolete, keep the record and update the current source of truth instead.
