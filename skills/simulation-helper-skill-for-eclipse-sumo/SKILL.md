...
- Detector-constrained SUMO demand reconstruction from real sensor counts, routeSampler residual correction, detector-route incidence matrices, anti-replay route priors, public-data boundaries, and month-long validation: `references/detector-constrained-demand-reconstruction.md`.
