...
from torii_sumo.core.osm_workflow_api import run_osm_cleanup_workflow_with_request
from torii_sumo.core.osm_workflow_request import (
    OsmWorkflowRequest,
    OsmWorkflowRuntime,
    OsmWorkflowScope,
    OsmWorkflowStageSettings,
    OsmWorkflowStageToggles,
)
...
def sumo_network_teacher_guided_junction_variant(
    ...
    return build_teacher_guided_junction_variant(
        ...
        source_conflict_core_node_ids=source_conflict_core_node_ids,
...
def sumo_osm_cleanup_workflow(
    ...
    request = OsmWorkflowRequest(
        ...
        stage_toggles=OsmWorkflowStageToggles(
        ...
        stage_settings=OsmWorkflowStageSettings(
    ...
    return run_osm_cleanup_workflow_with_request(request)
